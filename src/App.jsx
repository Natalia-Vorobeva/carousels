...
// Меню навигации (упрощенная версия)
const NavigationMenu = ({ 
  ...
  return (
    <>
      ...
      <button
        onClick={onToggle}
        className="fixed top-4 left-4 z-50 w-12 h-12 bg-black/80 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:bg-black transition-all shadow-lg hover:scale-105"
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className={`text-xs px-2 py-0.5 rounded-full ${
                      slide.difficulty === 'Тяжелый' ? 'bg-red-500/20 text-red-300' :
